<template>
    <div>
        <header class="header_title">
            <img src="./assets/img/left.png" onclick="window.history.go(-1)"/><span>订单详情</span>
        </header>
        <section>
            <div class="details">
            ...
            <div class="indent_bottom" v-for="item in order.items">
                ...
                <p>品类：{{item.category_name}}<span style="margin-left: 10px;">单位：{{item.unit}}</span>
                    <span class="indent_bottom_right">
							  		<span>&yen;：</span><span>{{item.price}}</span>
							  </span>
                </p>
